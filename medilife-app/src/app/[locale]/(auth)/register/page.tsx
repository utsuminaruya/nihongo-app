...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = async () => {
    ...
    await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: { redirectTo: `${window.location.origin}/${locale}/onboarding` }
    });
  };
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 space-y-4">
        ...
        <div className="space-y-3">
          <button onClick={handleGoogleRegister} type="button" className="w-full border border-gray-200 py-3 rounded-xl font-medium hover:bg-gray-50 transition flex items-center justify-center gap-3">
          ...
          <button type="button" className="w-full bg-[#06C755] text-white py-3 rounded-xl font-medium hover:bg-[#05b04d] transition flex items-center justify-center gap-3">
